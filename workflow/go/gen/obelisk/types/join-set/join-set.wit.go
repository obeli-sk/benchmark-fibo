...
// Package joinset represents the imported interface "obelisk:types/join-set@4.2.0".
package joinset
...
// ScheduleAt represents the type alias "obelisk:types/join-set@4.2.0#schedule-at".
//
// See [time.ScheduleAt] for more information.
type ScheduleAt = time.ScheduleAt

// DelayID represents the type alias "obelisk:types/join-set@4.2.0#delay-id".
//
// See [execution.DelayID] for more information.
type DelayID = execution.DelayID

// ResponseID represents the type alias "obelisk:types/join-set@4.2.0#response-id".
//
// See [execution.ResponseID] for more information.
type ResponseID = execution.ResponseID

// JoinSet represents the imported resource "obelisk:types/join-set@4.2.0#join-set".
//
// Join set resouce.
//
//	resource join-set
...
// JoinNextError represents the variant "obelisk:types/join-set@4.2.0#join-next-error".
//
