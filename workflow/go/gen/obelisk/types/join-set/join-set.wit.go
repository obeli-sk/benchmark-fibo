...
// Package joinset represents the imported interface "obelisk:types/join-set@6.0.0".
package joinset
...
// ResponseID represents the type alias "obelisk:types/join-set@6.0.0#response-id".
//
// See [execution.ResponseID] for more information.
type ResponseID = execution.ResponseID

// JoinSet represents the imported resource "obelisk:types/join-set@6.0.0#join-set".
//
// Join set resouce.
//
//	resource join-set
